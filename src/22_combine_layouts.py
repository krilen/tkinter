...
========================
Combing different layouts are done by thing logically about how to devide the window and using
frames.

More or less you use one frame and in it use a layout method and then adding all frames
together you have a window.
