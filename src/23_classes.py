"""
 TKINTER CLASSES
========================
We often take a widget often a frame by inheritance and add widgets to it.
After the frame is placed in the window.

This way you are able to orginize a lot of widgets easily.
...
class Menu(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        # place the widgets 
        menu_button1.grid(row=0, column=0, sticky="nswe", columnspan=2, pady=5, padx=5)
        menu_button2.grid(row=0, column=2, sticky="nswe",pady=5)
